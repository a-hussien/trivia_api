...
```
*Tip*
For better test all API resources, you can use tool like **Postman**
...
DELETE **/questions/<question_id>** Delete an existing questions from the available questions
...
POST **/questions** Add a new question to questions table
